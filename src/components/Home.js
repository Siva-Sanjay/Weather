...
import bg from '../images/weather.jpg'
...
const Home=()=>{
    ...
    useEffect(()=>{
        fetch(`http://api.openweathermap.org/data/2.5/weather?q=Kolkata&APPID=8d75ba2662e64120c2ce4ff25674a3ee&units=metric`)
          .then(response=>response.json())
          .then(data=>{
            setKol(data);
            console.log("kkt");
        })
        fetch(`http://api.openweathermap.org/data/2.5/weather?q=New%20Delhi&APPID=8d75ba2662e64120c2ce4ff25674a3ee&units=metric`)
          .then(response=>response.json())
          .then(data=>{
            setDel(data);
            console.log("del");
        })
        fetch(`http://api.openweathermap.org/data/2.5/weather?q=Hyderabad&APPID=8d75ba2662e64120c2ce4ff25674a3ee&units=metric`)
          .then(response=>response.json())
          .then(data=>{
            setHyd(data);console.log("hyd");
        })
        fetch(`http://api.openweathermap.org/data/2.5/weather?q=Mumbai&APPID=8d75ba2662e64120c2ce4ff25674a3ee&units=metric`)
          .then(response=>response.json())
          .then(data=>{
